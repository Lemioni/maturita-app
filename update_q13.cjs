...
4.  **NIC (Síťová karta)** – Zprostředkovává komunikaci mezi počítačem a síťovou infrastrukturou a obsahuje MAC adresu zařízeni.`;
    ...
    // Clear compactContent (User will provide later)
    if (questions[q13Index].compactContent) {
        delete questions[q13Index].compactContent;
    }

    fs.writeFileSync(filePath, JSON.stringify(questions, null, 2), 'utf8');
    console.log('Successfully updated Question 13.');
