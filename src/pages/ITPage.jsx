...
const ITPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-2">IT Otázky</h1>
        <p className="text-gray-600">47 maturitních otázek z IKT</p>
      </div>

      {/* Mode Selection */}
      <div className="bg-white rounded-xl shadow-md p-6 mb-6">
        <h2 className="text-lg font-semibold mb-4 text-gray-800">Režim učení</h2>
